...
describe('AcademicSemester unit tests', () =>{
    ...
    it('should instantiate a academicSemester without errors', () =>{
        ...
        expect(academicSemester.getNotification()?.getErrors().length).toBe(0)
    ...
    it('academicSemester notification should have one error', () =>{
        ...
        expect(academicSemester.getNotification()?.messages()).toBe('academicSemester: must inform academicSemester as actual,');
    })
    ...
    it('academicSemester notification should inform error beginning date', () =>{
        ...
        expect(academicSemester).toBeDefined();
        expect(academicSemester.getNotification()?.getErrors().length).toBe(1);
        expect(academicSemester.getNotification()?.messages()).toBe('academicSemester: academicSemester date beginning must be informed,');
    })
    ...
    it('academicSemester notification should inform error ending date', () =>{
        ...
        expect(academicSemester).toBeDefined();
        expect(academicSemester.getNotification()?.getErrors().length).toBe(1);
        expect(academicSemester.getNotification()?.messages()).toBe('academicSemester: academicSemester date ending must be informed,');
    })
    ...
    it('academicSemester notification should inform beginning date after ending date', () =>{
        ...
        const academicSemester = new AcademicSemester(actual, aValidBeginnig, aValidEnding);
        expect(academicSemester).toBeDefined();
        expect(academicSemester.getNotification()?.getErrors().length).toBe(2);
        expect(academicSemester.getNotification()?.messages()).toBe('academicSemester: the beginning date must be before ending date,academicSemester: the ending date must be after beginning date,');
    })
    ...
    it('academicSemester notification should inform beginning date on weekend', () =>{
        ...
        expect(academicSemester).toBeDefined();
        expect(academicSemester.getNotification()?.getErrors().length).toBe(1);
        expect(academicSemester.getNotification()?.messages()).toBe('academicSemester: the academicSemester must start in a weekday,');
    })
    ...
    it('academicSemester notification should inform ending date on weekend', () =>{
        ...
        expect(academicSemester).toBeDefined();
        expect(academicSemester.getNotification()?.getErrors().length).toBe(1);
        expect(academicSemester.getNotification()?.messages()).toBe('academicSemester: the academicSemester must end in a weekday,');
    })
