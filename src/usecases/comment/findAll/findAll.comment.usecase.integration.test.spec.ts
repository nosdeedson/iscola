...
import { FindAllCommentUseCase } from './findAll.comment.usecase';


describe('findAllCommentUseCase integration tests', () =>{
    ...
    it('should return an empty array', async () =>{
        const usecase = new FindAllCommentUseCase(commentRepository);
